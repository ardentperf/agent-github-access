...
echo "  workflow and then trigger it — effectively escaping its sandbox. The"
echo "  triggered workflow runs as GITHUB_TOKEN (branch protection still"
echo "  applies, but it can read all Actions secrets in the repo and make"
echo "  arbitrary outbound network calls)."
echo ""
